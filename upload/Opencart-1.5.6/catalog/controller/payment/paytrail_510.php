    ...
    $this->document->setTitle($this->language->get('heading_title'));
        ...
        if($this->config->get('paytrail_510_sandbox')){
           ...
           $this->paytrail_secret = 'SAIPPUAKAUPPIAS';
            ...
            $this->paytrail_secret = trim($this->config->get('paytrail_510_security'));
        }
        ...
        if(isset($payment->providers)){
           $this->data['providers'] = $payment->providers;
        } else {
      ...
      if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paytrail_510.tpl')) {
        $this->template = $this->config->get('config_template') . '/template/payment/paytrail_510.tpl';
      } else {
        $this->template = 'default/template/payment/paytrail_510.tpl';
      }
    ...
    protected function getBody(){
     ...
     if(!$error){     
        $body =  json_encode(array(
                    ...
                    'redirectUrls' => array(
                       'success' => $this->url->link('payment/paytraiL_510/omplete'),
