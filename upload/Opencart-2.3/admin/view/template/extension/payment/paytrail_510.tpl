          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="paytrail_510_merchant" value="<?php echo $paytrail_510_merchant; ?>" placeholder="<?php echo $placeholder_merchant; ?>" id="input-merchant" class="form-control" />
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="paytrail_510_security" value="<?php echo $paytrail_510_security; ?>" placeholder="<?php echo $placeholder_security; ?>" id="input-security" class="form-control" />
